            ...
            <div class="col-md-6">
                <div class="card">
                    <form class="box" method="POSt" action="validation.php">
                        ...
                        <br>
                        <a href="Form.php">
                            <button type="submit" name="submits" class="btn btn-outline-success btn-lg btn-block" style="border-radius: 20px;">Login</button>
                        </a>
                        <div class="col-md-12">
                            ...
                            <br><a class="forgot text-muted" href="#">I am a new user</a>
                            <a class="forgot" href="Signup.php">Sign up</a>
                        </div>
                    </form>
                </div>
            </div>
